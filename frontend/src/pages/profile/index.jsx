...
const ProfilePage = () => {
    ...
    const upadateProfilePicture = async (file) => {
        ...
        <DashboardLayout>
            ...
            <div className={styles.container}>
                <div className={styles.backDropContainer}>
                    ...
                    <input onChange={(e) => {
                        upadateProfilePicture(e.target.files[0])
                    }} type="file" id="profilePictureUpload" hidden />
                    <img className={styles.backDrop} src={`${BASE_URL}/${userProfile.userId.profilePicture}`} alt="profilePicture" />
                </div>
                    ...
                    <div style={{ display: "flex", gap: "0.7rem" }}>
                        ...
                        <div style={{flex: "0.8"}}>
                            ...
                            <div style={{ display: "flex", width: "fit-content", alignItems: "center", gap: "1.2rem"}}>
                                ...
                                <p style={{color: "silver"}}>@{userProfile.userId.username}</p>
                            </div>
                                    ...
                                    <div key={post._id} className={styles.postCard}>
                                        <div className={styles.card}>
                                            <div className={styles.card_profileContainer}>
                                                {post.media !== "" ? <img src={`${BASE_URL}/${post.media}`} alt='posts'></img> : <div style={{ width: "3.4rem", height: "3.4rem"}}> </div>}
                                            </div>
