                              ...
                              <div style={{display: "flex", justifyContent: "space-between"}}>
                                ...
                                <p style={{fontWeight: "bold"}}>{post.userId.name}</p>
                                {
                                  ...
                                  <div onClick={async () => {
                                    ...
                                    <svg style={{height: "1.5em", color: "red"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            ...
                            return (
                              <div className={styles.singleComment} key={comment._id}>
                                <div className={styles.singleComment_profileContainer}>
                                  <img width={40} height={50} src={`${BASE_URL}/${comment.userId.profilePicture}`} alt="ProfilePic" />
                                  <div>
                                    <p style={{ fontWeight: "bold", fontSize: "1.2rem" }}>{comment.userId.name}</p>
                                    <p style={{color: "silver"}}>@{comment.userId.username}</p>
                                  </div>
                                </div>
                                <p>
                                  {comment.body}
